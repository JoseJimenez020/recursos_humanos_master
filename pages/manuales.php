          ...
          <div class="mt-3 d-flex">
            <form method="POST" enctype="multipart/form-data" id="user_profile_documento_form">
              ...
              <div class="input-group input-group-static mb-4">
                ...
                <select name="DepartamentoId" id="departamento-registro" class="form-control">
                  <option value="">Seleccionar</option>
                  <?= GetListaDepartamentos($departamentos) ?>
                </select>
              </div>
              <div class="form-check my-2">
                <input class="form-check-input" type="checkbox" id="esPublico" name="EsPublico" value="1">
                <label class="form-check-label" for="esPublico">
                  Manual público (visible para todos)
                </label>
              </div>
