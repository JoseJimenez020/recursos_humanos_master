...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="main-content position-relative max-height-vh-100 h-100">
    ...
    <div class="container-fluid px-2 px-md-4">
      <div class="page-header min-height-200 border-radius-xl mt-4" style="background-image: url('<?= $imgSrc ?>');">
      ...
      <div class="card card-body mx-2 mx-md-2 mt-n6">
        <div class="row gx-4 mb-2">
          ...
          <div class="card-body p-3">
            ...
            <p class="text-xs mb-0"><strong class="text-xs font-weight-bold mb-0">Autor:</strong>
              <?= htmlspecialchars($fullName, ENT_QUOTES) ?></p>
