  ...
  if ($sesion['EsAdmin'] === 1) {
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active bg-gradient-primary text-white" href="../pages/valores.html">
  ...
  <div class="main-content position-relative max-height-vh-100 h-100">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Valores</li>
          </ol>
        </nav>
    ...
    <div class="container-fluid px-2 px-md-4">
      <div class="page-header min-height-300 border-radius-xl mt-4"
        style="background-image: url('../assets/img/illustrations/banner-valores.jpg');">
      ...
      <div class="card card-body mx-2 mx-md-2 mt-n6">
        <div class="row gx-4 mb-2">
          ...
          <div class="card-body p-3">
           <img class="card-img"
              src="../assets/img/illustrations/Valores.jpeg"
              alt="Card image">
