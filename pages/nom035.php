...
<body class="g-sidenav-show bg-gray-100">
  ...
  if ($sesion['EsAdmin'] === 1) {
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active bg-gradient-primary text-white" href="../pages/nom035.php">
            <i class="material-symbols-rounded opacity-5">comment</i>
            <span class="nav-link-text ms-1">NOM-035</span>
          </a>
        </li>
      </ul>
    </div>
  ...
  <div class="main-content position-relative max-height-vh-100 h-100">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">NOM-035</li>
          </ol>
        </nav>
    ...
    <div class="container-fluid px-2 px-md-4">
      <div class="page-header min-height-300 border-radius-xl mt-4"
        style="background-image: url('../assets/img/illustrations/banner-nom.jpg');">
          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              ...
              <p class="mb-0 font-weight-normal text-sm">
                Encuestas pendientes de contestar:
              </p>
            </div>
          </div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div>
                          <img src="../assets/img/icons/icon-logo.png" class="avatar avatar-sm me-3 border-radius-lg"
                            alt="user1">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0">Encuesta Número uno</h6>
                        </div>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <span class="badge badge-sm bg-gradient-success"
                        onclick="descargarPDF('../docs/example.pdf', 'example.pdf')">Contestar</span>
                    </td>
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold">23/04/18 05:20 p.m.</span>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="fcustomCheck1">
                        <label class="custom-control-label" for="customCheck1">Contestada</label>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0">Encuesta Número dos</h6>
                        </div>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <span class="badge badge-sm bg-gradient-success">Contestar</span>
                    </td>
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold">11/01/19 05:20 p.m.</span>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="fcustomCheck1">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0">Encuesta Número tres</h6>
                        </div>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
                    ...
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold">19/09/17 05:20 p.m.</span>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="fcustomCheck1">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0">Encuesta Número cuatro</h6>
                        </div>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
                    ...
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold">24/12/08 05:20 p.m.</span>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="fcustomCheck1">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0">Encuesta Número cinco</h6>
                        </div>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
                    ...
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold">04/10/21 05:20 p.m.</span>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="fcustomCheck1">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0">Encuesta Número seis</h6>
                        </div>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
                    ...
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold">14/09/20 05:20 p.m.</span>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="fcustomCheck1">
  ...
  <div class="fixed-plugin">
    <a class="fixed-plugin-button text-dark position-fixed px-3 py-2">
      <i class="material-symbols-rounded py-2">add_notes</i>
    </a>
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Añadir Encuesta</h5>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <div class="mt-3 d-flex">
          <form>
            ...
            <div class="input-group input-group-outline my-3">
              <label class="form-label">Enlace de la encuesta</label>
        ...
        <a class="btn bg-gradient-primary w-100" href="">Subir encuesta</a>
      </div>
    </div>
  </div>
  <!--   Core JS Files   -->
